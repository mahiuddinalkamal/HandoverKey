          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="card">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">Zero-Knowledge Encryption</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Your data is encrypted client-side before it ever reaches our servers. We never see your plaintext data.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Full transparency - inspect, verify, and contribute to the codebase. No hidden backdoors.
                  </p>
                </div>
              </div>
            </div>
