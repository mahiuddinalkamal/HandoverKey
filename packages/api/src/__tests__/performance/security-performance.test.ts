...
describe("Security Performance Tests", () => {
  describe("Email Validation Performance", () => {
    it("should validate normal emails quickly", () => {
      ...
      console.log(
        `Email validation: ${iterations} validations in ${duration}ms (${avgTime.toFixed(3)}ms avg)`,
      );
    ...
    it("should handle malicious ReDoS patterns efficiently", () => {
      ...
      console.log(
        `ReDoS patterns: avg ${avgTime.toFixed(2)}ms, max ${maxTime}ms`,
      );
    ...
    it("should maintain linear time complexity", () => {
      ...
      console.log(
        "Email validation scaling:",
        testSizes.map((size, i) => `${size}: ${times[i]}ms`).join(", "),
      );
  ...
  describe("UUID Validation Performance", () => {
    ...
    it("should handle malicious ReDoS patterns efficiently", () => {
      ...
      console.log(
        `UUID ReDoS patterns: avg ${avgTime.toFixed(2)}ms, max ${maxTime}ms`,
      );
    ...
    it("should maintain constant time complexity", () => {
      ...
      console.log(
        "UUID validation scaling:",
        testInputs
          .map((input, i) => `${input.length}: ${times[i]}ms`)
          .join(", "),
      );
  ...
  describe("Password Generation Performance", () => {
    ...
    it("should maintain consistent performance under load", () => {
      ...
      console.log(
        "Password generation scaling:",
        batchSizes
          .map((size, i) => `${size}: ${times[i].toFixed(3)}ms/pwd`)
          .join(", "),
      );
  ...
  describe("Authentication Performance", () => {
    ...
    it("should authenticate valid tokens quickly", () => {
      ...
      console.log(
        `JWT authentication: ${iterations} auths in ${duration}ms (${avgTime.toFixed(3)}ms avg)`,
      );
    ...
    it("should handle invalid tokens efficiently", () => {
      ...
      console.log(
        `Invalid token handling: avg ${avgTime.toFixed(2)}ms, max ${maxTime}ms`,
      );
    ...
    it("should handle optional authentication efficiently", () => {
      ...
      console.log(
        `Optional auth: avg ${avgTime.toFixed(2)}ms, max ${maxTime}ms`,
      );
  ...
  describe("Input Sanitization Performance", () => {
    ...
    it("should handle malicious input efficiently", () => {
      ...
      console.log(
        `Malicious input sanitization: avg ${avgTime.toFixed(2)}ms, max ${maxTime}ms`,
      );
    ...
    it("should scale reasonably with input size", () => {
      ...
      inputSizes.forEach((size) => {
        ...
        for (let i = 0; i < size; i++) {
          largeInput[`field${i}`] =
            `<script>alert("${i}")</script>` + "x".repeat(100);
        }
      ...
      console.log(
        "Sanitization scaling:",
        inputSizes.map((size, i) => `${size} fields: ${times[i]}ms`).join(", "),
      );
  ...
  describe("Overall Performance Impact", () => {
    it("should not significantly impact application performance", () => {
      ...
      console.log(
        `Complete pipeline: ${iterations} requests in ${duration}ms (${avgTime.toFixed(3)}ms avg)`,
      );
    ...
    it("should maintain performance under concurrent load", async () => {
      ...
      console.log(
        `Concurrent load: ${concurrentRequests} batches, max ${totalTime}ms, avg ${avgTime.toFixed(2)}ms`,
      );
