...
describe('Rate Limiting Middleware', () => {
  ...
  describe('createRateLimit', () => {
    ...
    it('should log security events when rate limit is exceeded', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('Security Event: Rate limit exceeded'),
        expect.any(Object)
      );
    });
  });
  ...
  describe('logValidationFailures', () => {
    it('should log validation failures', () => {
      ...
      logValidationFailures(mockRequest as Request, mockResponse as Response, mockNext);
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('Security Event: Validation failure: email'),
        expect.any(Object)
      );
    });
  ...
  describe('Predefined Rate Limiters', () => {
    ...
    it('should have validation rate limiter with correct settings', () => {
      validationRateLimit(mockRequest as Request, mockResponse as Response, mockNext);
      expect(mockNext).toHaveBeenCalled();
      expect(mockResponse.set).toHaveBeenCalledWith({
  ...
  describe('Security Edge Cases', () => {
    ...
    it('should prevent memory leaks by limiting security events', () => {
      ...
      mockRequest.query = {};
      getSecurityEvents(mockRequest as Request, mockResponse as Response);
      const lastCall = (mockResponse.json as jest.Mock).mock.calls.slice(-1)[0][0];
